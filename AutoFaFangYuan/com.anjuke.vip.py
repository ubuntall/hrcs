                ...
                try:
                    ...
                    if bianhao not in set_bianhao:
                        ...
                        if biaoti not in set_biaoti:
                            ...
                            browser.find_elements_by_class_name("ui-select-box")[2].click()
                            browser.find_elements_by_xpath("//li[@data-val='0']")[0].click()
                            browser.find_element_by_name('addressGJ').send_keys(keyWord)
                            browser.find_elements_by_class_name("ui-select-box")[4].click()  # 房屋情况
                            browser.find_element_by_xpath("//li[@data-val='8']").click()  # 普通住宅
                            browser.find_elements_by_class_name("ui-select-box")[5].click()
                            browser.find_elements_by_xpath("//li[@data-val='4']")[2].click()  # 精装
                            browser.find_elements_by_class_name("ui-select-box")[6].click()
                            browser.find_elements_by_xpath("//li[@data-val='2']")[3].click()  # 朝南
                            browser.find_elements_by_class_name("ui-select-box")[7].click()
                            ...
                            browser.find_element_by_name('unitArea').click()
                            # browser.find_element_by_name('unitArea').send_keys(mianji - 1)#套内面积
                            target = browser.find_elements_by_class_name("ui-select-box")[10]
                            browser.execute_script("arguments[0].scrollIntoView();", target)
                            browser.find_elements_by_class_name("ui-select-box")[10].click()
                            browser.find_elements_by_xpath("//li[@data-val='1']")[6].click()
                            browser.find_elements_by_class_name("ui-select-box")[11].click()
                            browser.find_elements_by_xpath("//li[@data-val='1']")[7].click()
                            browser.find_elements_by_class_name("ui-radio")[2].click()  # 满五年
                            browser.find_elements_by_class_name("ui-radio")[5].click()  # 唯一住房
                            tag = browser.find_element_by_name('title')
                            for filter in filters:
                                biaoti = biaoti.replace(filter, "")
                            tag.send_keys(biaoti)
