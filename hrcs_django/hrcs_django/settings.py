"""
Django settings for hrcs_django project.
...
SECRET_KEY = '!h2%@61o&2o+k)5ay_q&ye4kq77i(vmy34bzt!9zzsupj1rnt9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["192.168.31.199", "192.168.31.1", "127.0.0.1", "22465rj114.iask.in"]
...
WSGI_APPLICATION = 'hrcs_django.wsgi.application'
